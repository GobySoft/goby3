...
int goby::common::ApplicationBase3::argc_ = 0;
char** goby::common::ApplicationBase3::argv_ = 0;

goby::common::ApplicationBase3::ApplicationBase3(google::protobuf::Message* cfg /*= 0*/)
    : all_cfg_(cfg),
      base_cfg_(0),
      own_base_cfg_(false),
      alive_(true)
...
void goby::common::ApplicationBase3::__run()
{
