function(create_single_thread_app1_test interprocess_impl link_libraries)
  ...
  set(TEST goby_test_middleware_single_thread_app1_${interprocess_impl})
  ...
  add_test(${TEST} ${goby_BIN_DIR}/${TEST} -vvvv) 
endfunction()
