    ...
    try
    {
        ...
        if (in == "<EOP>")
        {
            const benthos::protobuf::ReceiveStatistics& rx_stats =
                rx_msg_.GetExtension(benthos::protobuf::tx_config).receive_stat();
        ...
        else if (in.compare(0, crc.size(), crc) == 0)
        {
            benthos::protobuf::ReceiveStatistics& rx_stats =
                *rx_msg_.MutableExtension(benthos::protobuf::tx_config)->mutable_receive_stat();
...
void goby::acomms::benthos::fsm::Range::in_state_react(const EvRxSerial& e)
{
    try
    {
        ...
        if (in.compare(0, range.size(), range) == 0)
        {
            ...
            range_msg.MutableExtension(benthos::protobuf::tx_config)
