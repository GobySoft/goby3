...
goby::common::LiaisonScope::LiaisonScope(const protobuf::LiaisonConfig& cfg)
    : LiaisonContainerWithComms<LiaisonScope, ScopeCommsThread>(cfg),
      pb_scope_config_(cfg.pb_scope_config()), history_model_(new Wt::WStringListModel(this)),
      model_(new LiaisonScopeProtobufModel(pb_scope_config_, this)),
      proxy_(new Wt::WSortFilterProxyModel(this)), main_layout_(new Wt::WVBoxLayout(this)),
      last_scope_state_(UNKNOWN), main_box_(new WGroupBox("Interprocess Messages")),
...
goby::common::LiaisonScope::create_row(const std::string& group,
...
void goby::common::LiaisonScope::update_row(const std::string& group,
...
void goby::common::LiaisonScope::pause() { controls_div_->pause(); }
...
void goby::common::LiaisonScope::inbox(const std::string& group,
...
goby::common::LiaisonScopeProtobufTreeView::LiaisonScopeProtobufTreeView(
...
goby::common::LiaisonScopeProtobufModel::LiaisonScopeProtobufModel(
...
goby::common::LiaisonScope::ControlsContainer::ControlsContainer(
    ...
    : Wt::WContainerWidget(parent), timer_(timer),
      play_pause_button_(new WPushButton("Play", this)), spacer_(new Wt::WText(" ", this)),
      play_state_(new Wt::WText(this)), is_paused_(start_paused), scope_(scope),
...
goby::common::LiaisonScope::HistoryContainer::HistoryContainer(
    ...
    : WContainerWidget(parent), main_layout_(main_layout), pb_scope_config_(pb_scope_config),
      hr_(new WText("<hr />", this)), add_text_(new WText(("Add history for group: "), this)),
      history_box_(new WComboBox(this)), history_button_(new WPushButton("Add", this)),
      buffer_(pb_scope_config.max_history_items()), scope_(scope)
{
...
void goby::common::LiaisonScope::HistoryContainer::add_history(
    const goby::common::protobuf::ProtobufScopeConfig::HistoryConfig& config)
{
...
void goby::common::LiaisonScope::HistoryContainer::display_message(
...
goby::common::LiaisonScope::RegexFilterContainer::RegexFilterContainer(
    ...
    const protobuf::ProtobufScopeConfig& pb_scope_config, Wt::WContainerWidget* parent /* = 0 */)
    : Wt::WContainerWidget(parent), model_(model), proxy_(proxy), hr_(new WText("<hr />", this)),
