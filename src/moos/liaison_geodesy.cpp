...
goby::common::LiaisonGeodesy::LiaisonGeodesy(const protobuf::LiaisonConfig& cfg,
                                             Wt::WContainerWidget* parent)
    : LiaisonContainer(parent), geodesy_config_(cfg.GetExtension(protobuf::geodesy_config)),
      mode_(DECIMAL_DEGREES), last_lat_(std::numeric_limits<double>::quiet_NaN()),
