...
{
  public:
    QueueBar(Wt::WContainerWidget* parent = 0) : Wt::WProgressBar(parent) {}
...
{
  public:
    MACBar(Wt::WContainerWidget* parent = 0) : Wt::WProgressBar(parent) {}
    Wt::WString text() const;
};
...
{
  public:
    LiaisonAcomms(ZeroMQService* zeromq_service, const protobuf::LiaisonConfig& cfg,
  ...
  private:
    ...
    void handle_modem_message(DriverStats* driver_stats, bool good,
